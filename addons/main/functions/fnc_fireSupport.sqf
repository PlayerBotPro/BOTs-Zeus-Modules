...
Edited by: PlayerBot
removed #include "script_component.hpp"
changed GVAR(spawnAreaMarker) to BOT_spawnAreaMarker
changed STR_CROWSZA_Misc_fire_support_start_after max time to 600 seconds
*///////////////////////////////////////////////
...
private _onConfirm =
{
	...
	if(_createDisplay) then {
		{
			[[_logic,_radius,_pos], BOT_spawnAreaMarker] remoteExec ["call", _x, true]; 
		} forEach allCurators;
	};
};
...
[
	...
	[
		...
		["SLIDER",localize "STR_CROWSZA_Misc_fire_support_start_after",[0,600,1,1],_isFireSupport],
